...
public class MailServiceTest extends SpringBootEmailApplicationTest {
    ...
    public void sendSimpleMail() {
        mailService.sendSimpleMail("picongzhi@meituan.com", "simple mail", "simple mail");
    }
    ...
    public void sendHtmlMail() throws MessagingException {
        ...
        mailService.sendHtmlMail("picongzhi@meituan.com", "html mail", emailTemplate);
    }
    ...
    public void sendHtmlMail2() throws MessagingException {
        ...
        mailService.sendHtmlMail("picongzhi@meituan.com", "html mail 2", emailTemplate);
    }

    @Test
    public void sendAttachmentsMail() throws MessagingException {
        URL url = ResourceUtil.getResource("static/duobao.JPG");
        mailService.sendAttachmentsMail("picongzhi@meituan.com", "mail with attachment", "附件", url.getPath());
    }
    ...
    public void sendResourceMail() throws MessagingException {
        ...
        URL url = ResourceUtil.getResource("static/duobao.JPG");
        mailService.sendResourceMail("picongzhi@meituan.com", "静态资源", content, url.getPath(), rscId);
    }
}
